...
var lastNames = []string{
	...
	"Dach", "DAmore", "Daniel", "Dare", "Daugherty", "Davis", "Deckow", "Denesik", "Dibbert", "Dickens", "Dicki", "Dickinson", "Dietrich", "Donnelly", "Dooley", "Douglas", "Doyle", "DuBuque", "Durgan",
	...
	"Oberbrunner", "OConnell", "OConner", "OHara", "OKeefe", "OKon", "Okuneva", "Olson", "Ondricka", "OReilly", "Orn", "Ortiz", "Osinski",
